-- CoffeeCoder · seed de artículos y demos (desarrollo).
-- GENERADO desde seed/articulo-ejemplo.md y seed/demos/*.html.
-- Idempotente: UUIDs fijos + ON CONFLICT. Se aplica después de dev.sql.

BEGIN;

-- Biblioteca de demos del curso "Go desde cero".
INSERT INTO demos (id, course_id, slug, title, html, height_px) VALUES
  ('00000000-0000-4000-8000-050000000001', '00000000-0000-4000-8000-020000000001', 'channels-buffer', 'Channels con y sin buffer', $demo_ch$<!doctype html>
<html lang="es">
<head>
<meta charset="utf-8">
...
INSERT INTO demos (id, course_id, slug, title, html, height_px) VALUES
  ('00000000-0000-4000-8000-050000000002', '00000000-0000-4000-8000-020000000001', 'lfo-amplitud', 'LFO: modulación de amplitud', $demo_lfo$<!doctype html>
<html lang="es">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
...
-- gratis para poder verla sin comprar. duration_s = tiempo de lectura
-- estimado con la misma fórmula que internal/content.ReadingTime.
